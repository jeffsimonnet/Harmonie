...
/* pages/formulaire/_funnelSubventions.html.twig */
class __TwigTemplate_bd2d05becd5d61d6b12b734754a5e4068cabac35a4505ec3dc7256a7be5d0e2c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 1
        echo "<section class=\"funnelSubventions\">
    <div>
        <div class=\"timeline\">
            <ul class=\"nostyle\">
                <li>Type de bien</li>
                <li>Localisation</li>
                <li>Nombre de lots</li>
                <li>Commentaires</li>
                <li>Coordonnées</li>
            </ul>
        </div>
        ...
        <div class=\"step\" id=\"step-3\">
            <h2><em>Combien de lots</em> composent l'immeuble ?</h2>
            <div class=\"content\">
                <form>
                    <div><input type=\"radio\" name=\"lots\" value=\"mois de 25\" id=\"lots-1\" required /> <label for=\"lots-1\">Moins de 25</label></div>
                    <div><input type=\"radio\" name=\"lots\" value=\"entre 25 et 50\" id=\"lots-2\" required /> <label for=\"lots-2\">Entre 25 et 50</label></div>
                    <div><input type=\"radio\" name=\"lots\" value=\"entre 50 et 100\"id=\"lots-3\" required /> <label for=\"lots-3\">Entre 50 et 100</label></div>
                    <div><input type=\"radio\" name=\"lots\" value=\"plus de 100\" id=\"lots-4\" required /> <label for=\"lots-4\">Plus de 100</label></div>
                    </ul>
                </form>
            </div>
            <a href=\"javascript:;\" class=\"nav prev\">Retour</a>
...
<script>
    ...
    document.querySelectorAll(\".next, .finish\").forEach(i => i.addEventListener(\"click\", function (e) {
        ...
        // line 155
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("funnel_subventions_ajax_submit");
...
<script
    src=\"https://maps.googleapis.com/maps/api/js?key=";
        // line 270
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 270), "server", [], "any", false, false, false, 270), "get", [0 => "PLACES_API_KEY"], "method", false, false, false, 270), "html", null, true);
...
></script>";
    ...
    {
        return "pages/formulaire/_funnelSubventions.html.twig";
    }
    ...
    {
        return array (  311 => 270,  193 => 155,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "pages/formulaire/_funnelSubventions.html.twig", "/var/www/dev.harmonie.aquaray.com/web/templates/pages/formulaire/_funnelSubventions.html.twig");
    }
}
